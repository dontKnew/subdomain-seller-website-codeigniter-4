            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php if ($data): ?>
                        ...
                        <form action="<?= base_url("admin/home-slider") ?>" method="post" >
                            ...
                            <table class="table table-head-bg-primary table-striped table-hover text-center">
                                ...
                                <?php foreach ($data as $value): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?= base_url() . "/backend/img/slider/compress/" . esc($value['image']) ?>"
                                                 alt="<?= esc($value['title']) ?>" width="100" height="auto">
                                        </td>
                                        <td><?= esc(ucwords($value['status'])) ?></td>
                                        <td>
                                            <a href="<?= base_url() . "/admin/home-slider/delete/" . $value['id'] ?>"
                        ...
                        <?php if ($pager) :?>
                            <?php $pagi_path='admin/home-slider'; ?>
