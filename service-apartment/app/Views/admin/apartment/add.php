                ...
                <form action="<?= base_url("admin/apartment/add") ?>" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                                ...
                                <select name="states" class="form-control input-solid mx-md-1 mx-sm-1 my-1" required>
                                    <?php if($states): ?>
                                        <?php foreach($states as $value): ?>
                                            <option value="<?= $value['name'] ?>"><?= ucwords(esc($value['name'])) ?></option>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                        ...
                        <div class="form-group ">
                            ...
                            <input type="number"  name="price_start" value="2000" style="appearance: :none" class="form-control input-solid" required>
                        </div>
                        <div class="form-check">
                            <label>Shift Timing </label><br/>
                            <label class="form-radio-label">
                                <input class="form-radio-input" type="radio" name="shift_time" value="Day" checked required>
                                <span class="form-radio-sign">Day</span>
                            </label>
                            <label class="form-radio-label ml-3">
                                <input class="form-radio-input" type="radio" name="shift_time" value="Night" required>
