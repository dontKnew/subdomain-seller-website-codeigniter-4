    ...
    <div class="row d-flex justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <form action="<?= base_url("admin/apartment/".$data['id']) ?>" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                                ...
                                <select name="states" class="form-control input-solid mx-md-1 mx-sm-1 my-1" required>
                                    <?php if($states): ?>
                                        <?php foreach($states as $value): ?>
                                            <option value="<?= $value['name'] ?>" <?php if($value['name']==$data['states']): echo "selected"; endif; ?>>
                                                <?php if($value['name']==$data['states']):
                                                        echo ucwords(esc($data['states']));
                                                    else:
                                                        echo ucwords(esc($value['name']));
                                                endif; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                        ...
                        <div class="form-group">
                            ...
                            <img src="<?= base_url()."/backend/img/apartment/compress/". esc($data['image'])?>" alt="<?= esc($data['title']) ?>" width="100" height="auto">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-radio-label">
                                <input class="form-radio-input" type="radio" name="shift_time" value="Day"  <?php if(ucwords($data['shift_time'])=="Day"): echo "checked"; endif;?> required>
                                <span class="form-radio-sign">Day</span>
                            </label>
                            <label class="form-radio-label ml-3">
                                <input class="form-radio-input" type="radio" name="shift_time" value="Night" <?php if(ucwords($data['shift_time'])=="Night"): echo "checked"; endif;?> required>
