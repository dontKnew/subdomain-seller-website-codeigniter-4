            ...
            try {
                ...
                if ($this->form_validation->run() == FALSE){
                    ...
                    if($_FILES['image']['name']!==''){
                        ...
                        $config['file_name'] = strtolower("gallery_page_" . time() . "." . $ext);
                        ...
                        $this->session->set_flashdata('err', 'Please attach an image');
...

    {
        ...
        if ($this->input->server('REQUEST_METHOD') == 'POST')
        {
...

            {
                ...
                $data = $this->db->where('id', $id)->get('gallary')->row_array();
                if($_FILES['image']['name']!='')

                {
                    ...
                    $_POST['image'] = $config['file_name'];
                    unlink("./uploads/gallary/".$data['image']);
                }else {
