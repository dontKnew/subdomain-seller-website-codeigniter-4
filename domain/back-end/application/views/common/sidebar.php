...
<!--            <li>-->
<!---->
<!--                <a href="#" class="waves-effect"><span class="nav-icon"><i class="fa fa-table"></i></span><span class="nav-label">Accommodation Type</span></a>-->
<!--                <ul>-->
<!--                    <li><a href="--><?//= base_url('admin/accommodation-type/add'); ?><!--">Add Accommodation Type</a>-->
<!--                    <li><a href="--><?//= base_url('admin/accommodation-type'); ?><!--">View Accommodation Type</a></li>-->
<!--                    <li><a href="--><?//= base_url('admin/accommodation-type/customize'); ?><!--">Customize Accommodation</a>-->
<!--                </ul>-->
<!---->
<!--            </li>-->
            ...
            <li>
            <a href="<?= base_url('seotools'); ?>" class="waves-effect"><span class="nav-icon"><i class="fa fa-table"></i></span><span class="nav-label">SEO Tool</span></a>
         </li>
