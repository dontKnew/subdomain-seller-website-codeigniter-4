                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        ...
                                        <li class="active-page"> Edit category</li>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <label> Status</label>
                                         ...
                                         <select class="form-control" name="status">
                                             ...
                                             <option <?php if($category['status']=='Active'){ echo 'selected'; }?>>Active</option>

                                             <option <?php if($category['status']=='Inactive'){ echo 'selected'; }?>>Inactive</option>
