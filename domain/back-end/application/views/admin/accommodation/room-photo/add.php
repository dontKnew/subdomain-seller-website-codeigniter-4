                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        ...
                                        <li class="active-page">Room Photo </li>
                        ...
                        <div class="box-widget widget-module">
                            ...
                            <div class="widget-container">
                                ...
                                <div class=" widget-block">
                                    ...
                                    <form action="<?= base_url("admin/room-photo/add") ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="portion_name"  class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Room Photo </label>
                                            <input type="file" name="preview_photo"  class="form-control">
                                        </div>
                                        <div class="form-group">
