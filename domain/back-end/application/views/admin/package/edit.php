<?php use function Symfony\Component\String\b;$this->load->view('common/head') ?>
                                ...
                                <div class="page-breadcrumb-wrap">
                                    ...
                                    <div class="page-breadcrumb-info">
                                        ...
                                        <ul class="list-page-breadcrumb">
                                            ...
                                            <li class="active-page"> Edit package</li>
                            ...
                            <div class="box-widget widget-module">
                                ...
                                <div class="widget-container">
                                    ...
                                    <div class=" widget-block">
                                        ...
                                        <form action="<?= base_url('admin/package/edit/' . $package['id']) ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img src="<?= base_url('uploads/package/'.$package['image'])?>" height="auto" width="150" class="img-rounded" alt="<?= $package['name'] ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="status">
                                                    ...
                                                    <option <?php if ($package['status'] == 'Active') {
                                                                echo 'selected';
                                                            } ?>>Active</option>

                                                    <option <?php if ($package['status'] == 'Inactive') {
                                                                echo 'selected';
                                                            } ?>>Inactive</option>
