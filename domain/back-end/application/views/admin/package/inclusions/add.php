                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        ...
                                        <li><a href="<?= base_url("admin/inclusions")?>">Home</a>

                                        </li>

                                        <li class="active-page">Add Inclusions </li>
                        ...
                        <div class="box-widget widget-module">
                            ...
                            <div class="widget-container">
                                ...
                                <div class=" widget-block">
                                    ...
                                    <form action="<?= base_url("admin/inclusions/add") ?>" method="post" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="<?= base_url('admin/package/add') ?>" class="btn btn-sm btn-primary text-center" style="margin:10px 0 10px 0"> Add Package <i class="fa fa-plus"></i></a>
                                            <select class="form-control" name="package_id">
                                                <?php foreach($all_package as $f){
