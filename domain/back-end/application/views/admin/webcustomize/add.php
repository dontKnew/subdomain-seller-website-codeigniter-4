                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        ...
                                        <li class="active-page"> Add company</li>
                    ...
                    <div class="box-widget widget-module">
                            ...
                            <div class="widget-container">
                                ...
                                <div class=" widget-block">
                                    ...
                                    <form action="<?= base_url('admin/company/add')?>" method="post" enctype="multipart/form-data">
                                     ...
                                     <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <label>Company Domain(Without www and http eg. xyz.domain.com)</label>
                                         ...
                                         <input type="text" name="domain" value="<?= set_value('domain')?>" class="form-control"  required="">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <label>Company Mobile</label>
                                         ...
                                         <input type="text" name="mobile" value="<?= set_value('mobile')?>" class="form-control"  required="">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <label>Company Whatsapp</label>
                                         ...
                                         <input type="text" name="whatsapp" value="<?= set_value('whatsapp')?>" class="form-control"  required="">
                                     ...
                                     <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <label>Company Maps (Google Embedd code paste here)</label>
                                         ...
                                         <textarea name="maps" value="<?= set_value('maps')?>" class="form-control"  required=""></textarea>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <label>Company Favicon</label>
                                         ...
                                         <input type="file" name="favicon" value="<?= set_value('favicon')?>" class="form-control"  required="">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <label>Youtube Video ID</label>
                                         ...
                                         <input type="text" name="video_id" value="<?= set_value('video_id')?>" class="form-control"  required="">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <label>Home Page Desc 1</label>
                                         ...
                                         <textarea name="desc1" class="form-control full-editor"  required=""><?= set_value('desc1')?></textarea>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <label>Home Page Desc 2</label>
                                         ...
                                         <textarea name="desc2" class="form-control full-editor"  required=""><?= set_value('desc2')?></textarea>
