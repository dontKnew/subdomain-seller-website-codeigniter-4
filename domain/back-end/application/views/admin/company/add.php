                        ...
                        <div class="box-widget widget-module">
                            ...
                            <div class="widget-container">
                                ...
                                <div class=" widget-block">
                                    ...
                                    <form action="<?= base_url('admin/company/add') ?>" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <!--                                            <small>Hint : without <span class="text-danger"> <strong> www and http/https </strong> eg. xyz.domain.com </span></small>-->
                                                <span class="input-group-addon" id="basic-addon2"><?= get_domain(DOMAIN) ?></span>
                                            </div>
                                            <small>Example : http://<span class="text-warning">companydomain</span>.<?= get_domain(DOMAIN) ?></small>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mobile" value="706521377" class="form-control"
                                                   required="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea  name="address" class="form-control full-editor" required>
                                                  Vill. Santoshpur Choi, <br/>Near Hanuman Dham,<br/>
