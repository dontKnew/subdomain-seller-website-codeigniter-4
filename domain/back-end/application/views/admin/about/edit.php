                    ...
                    <div class="box-widget widget-module">
                            ...
                            <div class="widget-container">
                                ...
                                <div class=" widget-block">
                                    ...
                                    <form action="<?= base_url('about/point-word/edit/').$id?>" method="post" >
                                        <div class="form-group">
                                            <label>Domain </label>
                                            <input type="text" class="form-control" name="domain" value="<?php echo strtolower($this->session->sessionDomain); ?>" required>
                                        </div>
